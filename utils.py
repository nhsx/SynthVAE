...
def general_pre_proc(data_supp, user_categorical_columns, user_continuous_columns, user_datetime_columns, pre_proc_method):

    # Specify column configurations

    original_categorical_columns = user_categorical_columns
    original_continuous_columns = user_continuous_columns
    original_datetime_columns = user_datetime_columns
